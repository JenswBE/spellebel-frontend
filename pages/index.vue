<template>
  <v-container fluid class="pa-0">
    <v-row no-gutters>
      <v-col>
        <v-img eager src="/img/raam.jpg" height="95vh">
              ...
              <v-col cols="10" offset="1" lg="6" offset-lg="3">
                ...
                >
                  <p class="text-h3 text-center">
                    <span class="px-5 pt-1 pb-2">Welkom bij</span>
                  </p>
                  <v-img
    ...
    <v-row class="py-10">
      <v-col>
        <v-container>
          <v-row>
            <v-col>
              <h2 class="text-h4">Jouw bibliotheek voor speelgoed</h2>
            </v-col>
          </v-row>
          <v-row>
            <v-col>
    ...
    <v-row class="blue lighten-1 py-8">
      <v-col>
        <v-container>
          <v-row align="center">
            <v-col cols="10" offset="1" sm="3" offset-sm="0">
              <v-img src="/img/nieuwtje-small.jpg" class="rounded-circle" />
            </v-col>
            <v-col cols="12" sm="9">
              <h2 class="text-h4 pb-2">Nieuwtje!</h2>
              <p class="text-body-1">
                Pharetra magnis etiam torquent cursus cubilia est conubia
                volutpat, enim imperdiet luctus hac suscipit vitae. Ac
                scelerisque pretium natoque elementum sed in potenti blandit
                gravida eros rhoncus risus, sociis eu sapien lobortis odio
                molestie turpis ad dictumst convallis fringilla neque, proin
                nisl libero est sodales vitae inceptos fames curabitur erat
                cursus. Lacus id ornare mus urna himenaeos proin eu,
                pellentesque cubilia lobortis sollicitudin dignissim euismod
                taciti quis, dictum ad maecenas inceptos ullamcorper velit.
              </p>
            </v-col>
          </v-row>
        </v-container>
    ...
    <v-row no-gutters class="py-15">
      <v-col>
        <v-container>
          <v-row>
            <v-col>
              <h2 class="text-h4 pb-5">Spellebel in cijfers</h2>
            </v-col>
          </v-row>
          <v-row align="center">
            <v-col cols="12" lg="4">
...
import { mdiAccountMultiple, mdiTeddyBear } from '@mdi/js'
