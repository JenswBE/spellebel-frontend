  ...
  <v-container fluid class="pa-0">
          ...
          <v-container fill-height>
            <v-row>
              <v-col cols="10" offset="1" lg="6" offset-lg="3">
                <div
                  class="d-flex flex-column align-center lime rounded-circle pa-15"
                >
          ...
          <v-row>
            <v-col lg="10" offset-lg="2">
              <p class="text-body-1">
                ...
                uitlenen, net zoals een bibliotheek dat met boeken doet.
                <br />Wij streven er naar om een verscheiden aanbod aan te
                bieden. Zo kan je er heel wat “ander” speelgoed vinden dan dat
                je thuis al in de kast hebt liggen of wil kopen.
              </p>
              <p>
    ...
    <v-row no-gutters class="py-15">
      <v-col>
        <v-container>
          <v-row>
            <v-col lg="9" offset-lg="3">
              <h2 class="text-h4 pb-5">Spellebel in cijfers</h2>
            </v-col>
          </v-row>
          <v-row align="center">
            <v-col sm="4" lg="2" offset-lg="3">
